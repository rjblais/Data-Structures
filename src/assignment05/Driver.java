...
public class Driver {
	public static void main(String[] args) {
		...
		// Minimum Spanning Tree and the Total Cost (Prim's)
		graph.printMinimumSpanningTree();
		
		System.out.println();
		System.out.println("Enter a series of two locations to be connected (enter quit to terminate): ");
		...
		while (true) {
			...
			if (from.equalsIgnoreCase("quit")) return;
